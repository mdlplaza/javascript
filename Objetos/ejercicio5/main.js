/*Vamos a hacer un generador de nombres de superhéroe. Pide al usuario la fecha de nacimiento, el nombre y el apellido. Muestra el nombre de superhéroe de la siguiente manera: la primera letra del nombre indicará la propiedad del objeto letra Nombre que debes obtener, la última letra del apellido indicará la propiedad del objeto letraApellido que debes obtener y último número del año de la fecha de nacimiento indicará la propiedad del objeto fechaNacimiento que debes obtener. Muestra el nombre conseguido.
...
let surname = window.prompt("dime tu apellido")
let date = window.prompt("fecha nacimiento dd/mm/aaaa")

let letraNombre2 = name.charAt(0)
console.log(letraNombre2)
let letraApellido2 = surname.charAt(surname.length-1)
console.log(letraApellido2)
let fechaNacimiento2 = "num" + date.charAt(date.length-1)
console.log(fechaNacimiento2)
 
console.log(letraNombre[letraNombre2]["femenino"])
console.log(letraApellido[letraApellido2]["femenino"])
console.log(fechaNacimiento[fechaNacimiento2]["femenino"])
