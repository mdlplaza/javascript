/*Pedir al usuario tres nombres de planetas del Sistema Solar. Con el objeto Sistema Solar, muestra los datos de los tres planetas elegidos. Asegúrate de que los nombres existen (y coinciden con las claves del objeto) y de que el usuario no introduce valores repetidos.
Los 3 planetas deberán aparecer en el navegador, cada uno dentro de una card. Los tres estarán colocados uno junto al otro, alineados horizontalmente.
Arriba del todo de la card aparecerá el nombre, luego la imagen y después las características (color y temperatura).
*/
...
let planeta1= window.prompt("Nombre planeta 1")
let planeta2 = window.prompt("Nombre planeta 2")
let planeta3 = window.prompt("Nombre planeta 3")

if (!sistemaSolar[planeta1] || !sistemaSolar[planeta2] || !sistemaSolar[planeta3]){
  console.log("algun planeta no existe")
} 
